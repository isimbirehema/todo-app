...
console.log("tasks.js router loaded"); // Debug: confirm router is loaded
...
router.get('/public', async (req, res) => {
  console.log("/tasks/public route hit"); // Debug: confirm route is reached
  try {
    const tasks = await Task.find();
    console.log("Tasks fetched:", tasks); // Debug: show tasks from DB
